...
def base_prompt_template(childe_name:str, number_of_years_child:int, topic:str,
                         moral_value:str, story_genere:str,
                         language:str, pages:int, words_per_page:int) -> str:
    """
    Generate a prompt for the story generator
    """
    base_prompt_template = f"""
    Eres el mejor contador de historias del mundo. Tu propósito es es escribir una historia para {childe_name}.
    ...
    Deberás tener en cuenta que la edad de {childe_name} es {number_of_years_child} años. Adaptrás el lenguaje y
    ...
    Cada página debe tener un máximo de {words_per_page} palabras. 
    """
